...
static pa_hook_result_t device_state_changed_hook_cb(pa_core *c, pa_object *o, pa_device_manager *dm) {
    ...
    if (pa_sink_isinstance(o)) {
        ...
        /* need to update the output device state that belongs to this sink */
        device_item = pa_device_manager_get_device_with_sink(s);
        if (device_item) {
        ...
        /* need to update the input device state that belongs to this source */
        device_item = pa_device_manager_get_device_with_source(s);
        if (device_item) {
