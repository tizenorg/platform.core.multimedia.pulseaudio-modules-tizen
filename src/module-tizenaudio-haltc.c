...
/***** UTC *****/
static int32_t utc_notify_stream_connection_changed_p(pa_hal_interface *h)
{
    int32_t ret = 0;
...
static int32_t utc_notify_stream_connection_changed_n(pa_hal_interface *h)
{
    int32_t ret = 0;
    hal_stream_connection_info info;
...
static int32_t utc_update_route_p(pa_hal_interface *h)
{
    int32_t ret = 0;
    hal_route_info info;
...
static int32_t utc_update_route_n(pa_hal_interface *h)
{
    int32_t ret = 0;
    hal_route_info info;
...
/***** ITC *****/
static int32_t itc_set_get_volume_level_p(pa_hal_interface *h)
{
    int32_t ret = 0;
...
static int32_t itc_set_get_volume_level_n(pa_hal_interface *h)
{
    int32_t ret = 0;
...
static int32_t itc_pcm_open_close_p(pa_hal_interface *h)
{
    int32_t ret = 0;
...
static int32_t itc_pcm_open_close_n(pa_hal_interface *h)
{
    int32_t ret = 0;
    pcm_handle pcm_h = NULL;
    pa_sample_spec sample_spec;
...
testcase tc_array[] = {
/***** UTC *****/
    {"UTC_notify_stream_connection_changed_p", utc_notify_stream_connection_changed_p},
    {"UTC_notify_stream_connection_changed_n", utc_notify_stream_connection_changed_n},
    {"UTC_update_route_p", utc_update_route_p},
    {"UTC_update_route_n", utc_update_route_n},
/***** ITC *****/
    {"ITC_set_get_volume_level_p", itc_set_get_volume_level_p},
    {"ITC_set_get_volume_level_n", itc_set_get_volume_level_n},
    {"ITC_pcm_open_close_p", itc_pcm_open_close_p},
    {"ITC_pcm_open_close_n", itc_pcm_open_close_n},
    {NULL, NULL}
};

static void do_test_cases(pa_hal_interface *h)
{
    int32_t i = 0;
    int32_t success = 0;
    int32_t failure = 0;
